(function () {
  if (!window.__coinboxConnectionMonitorInstalled && typeof window.fetch === "function") {
    ...
    if (!document.getElementById("coinbox-connection-style")) {
      const popupStyle = document.createElement("style");
      popupStyle.id = "coinbox-connection-style";
      popupStyle.textContent = `
        #coinbox-connection-lost-overlay {
          position: fixed;
          top: 0;
          right: 0;
          bottom: 0;
        ...
        #coinbox-connection-lost-overlay[data-visible="1"] {
          display: flex;
        }
    ...
    overlay.id = "coinbox-connection-lost-overlay";
...
const links = [
  {
    href: "/sounds/",
    label: "Sounds",
    isActive: (path) => path === "/" || path === "/sounds" || path.startsWith("/sounds/"),
  },
  {
    href: "/settings",
    label: "Settings",
