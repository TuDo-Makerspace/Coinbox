(function () {
  function installNavbar() {
    ...
    if (!container || container.dataset.coinboxNavbarMounted === "1") {
      return;
    }
    container.dataset.coinboxNavbarMounted = "1";
  ...
  if (document.readyState === "loading") {
    document.addEventListener("DOMContentLoaded", installNavbar, { once: true });
  }
  installNavbar();
})();
